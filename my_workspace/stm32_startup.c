...
void NMI_Handler 					(void) __attribute__ ((weak, alias("Default_Handler")));	//By default weak functions are created so that programmer can override these functions
...
// note: reserved places are made 0
uint32_t vector[] = {
STACK_START,
...
// initialization of .data and .bss section is done here
void Reset_Handler(void )
{
	// initialize the .data section in the SRAM
	// initialize the .bss section in the SRAM
	// call the standard library , if used
	// call the main function
}

void Default_Handler(void)	// alias function created
{
